...
/**
 * Represents the different ways the RTC can be handled- note, there are actually two RTCs, one in each CIA chip.
 ...
 * Partial realtime- time can be set in sim, but this is treated as offset- passage of time happens in realtime
